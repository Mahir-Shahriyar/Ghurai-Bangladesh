...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 13, 2021 at 04:29 PM
...
INSERT INTO `admin` (`adminid`, `admin_name`, `admin_mail`, `admin_pass`) VALUES
(1, 'Mahir', 'admin@ghuraibangladesh.com', 'mahir11'),
(2, 'Nuzhat', 'admin@ghuraibangladesh.com', 'nuzhat11');
...
INSERT INTO `complainbox` (`complain_no`, `complain`, `cust_email`) VALUES
(1, ' the Lake view road is broken', 'jui@gmail.com'),
(2, '                Your guide is not responsive much as I had to call him but he is not receiving calls ', 'mehab@gmail.com');
...
(1, 'Mehab', 'mehab@gmail.com', '11112222', '1111', 0),
...
(9, 'jui', 'jui@gmail.com', '12345678', '1122', 0);
...
--
ALTER TABLE `complainbox`
  MODIFY `complain_no` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
