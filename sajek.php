            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-4 col-sm-4">
                        <a href="sajek_hotel.php">
                        <div class="card-deck">
                            <div class="card">
                                <img class="card-img-top" src="images/sajekresort.jpg">
                                <div class="card-body">
                                    <h3>Hotel</h3>
                                </div>
                            </div>
                    ...
                    <div class="col-md-4 col-sm-4">
                          <a href="sajek_transport.php">
                        <div class="card-deck">
                            <div class="card">
                                <img class="card-img-top" src="images/cgari.jpg">
                                <div class="card-body">
                                    <h3>Transport</h3>
